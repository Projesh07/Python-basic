...
#Please don't run this whole python script at a time
#Go throw the each part and comment out the other part so that there won't be any error or over head
...
#------------------------This part is without using any context manager----------------------
